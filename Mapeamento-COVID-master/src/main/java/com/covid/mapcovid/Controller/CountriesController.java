...
public class CountriesController {
	...
	public String countryChange(@RequestParam(defaultValue = "Brazil") String country, Model model) {
		...
		model.addAttribute("porcentagemInfectados", countrySelect.getPorcentagemInfec());
		model.addAttribute("porcentagemAtivos", countrySelect.getPorcentagemAtiv());
		model.addAttribute("porcentagemCriticos", countrySelect.getPorcentagemCritic());
		model.addAttribute("porcentagemObitos", countrySelect.getPorcentagemObt());
		model.addAttribute("porcentagemRecuperados", countrySelect.getPorcentagemRecup());
