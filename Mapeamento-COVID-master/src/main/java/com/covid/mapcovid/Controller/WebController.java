...
public class WebController {
	...
	public String index(Model model) {
		...
		model.addAttribute("porcentagemInfectados", continentSelect.getPorcentagemInfec());
		model.addAttribute("porcentagemAtivos", continentSelect.getPorcentagemAtiv());
		model.addAttribute("porcentagemCriticos", continentSelect.getPorcentagemCritic());
		model.addAttribute("porcentagemObitos", continentSelect.getPorcentagemObt());
		model.addAttribute("porcentagemRecuperados", continentSelect.getPorcentagemRecup());
